...
import yaml
from einops import rearrange
from back.model.transformer import TransformerEncoder, TransformerDecoder, TransformerModulator
...
class StyleTransformer(nn.Module):
    def __init__(self, cfg, num_frame, dim_emb, num_heads, num_enc_blocks, num_dec_blocks):
        ...
        self.learnable_sty_token = nn.Parameter(torch.randn(num_bodypart, dim_emb))
